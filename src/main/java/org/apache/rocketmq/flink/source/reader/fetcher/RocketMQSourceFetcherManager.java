...
public class RocketMQSourceFetcherManager<T>
    ...
    public void commitOffsets(Map<MessageQueue, Long> committedOffsets) {
        ...
        if (splitFetcher != null) {
            commit(splitFetcher, committedOffsets);
        } else {
    ...
    private void commit(
        ...
        splitFetcher.enqueueTask(
                new SplitFetcherTask() {
                    ...
                    @Override
                    public boolean run() {
                        rocketMQReader.notifyCheckpointComplete(committedOffsets);
                        return true;
                    }
